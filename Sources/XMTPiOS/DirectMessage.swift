...
public enum ConversationContainer: Codable {
	...
	public func decode(with client: Client) -> DirectMessage {
		switch self {
...
public enum DirectMessage: Sendable {
...
extension DirectMessage: Hashable, Equatable {
	public static func == (lhs: DirectMessage, rhs: DirectMessage) -> Bool {
		lhs.topic == rhs.topic
	}
