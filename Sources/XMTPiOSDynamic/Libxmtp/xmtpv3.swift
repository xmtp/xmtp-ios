...
open class FfiConsentCallbackImpl: FfiConsentCallback, @unchecked Sendable {
	...
	// - Parameter noPointer: Placeholder value so we can have a constructor separate from the default empty one that may
	...
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonsentcallback(self.pointer, $0) }
	}
...
private enum UniffiCallbackInterfaceFfiConsentCallback {
	// Create the VTable using a series of closures.
	// Swift automatically converts these into C callback functions.
	//
	// This creates 1-element array, since this seems to be the only way to construct a const
	// pointer that we can pass to the Rust code.
	static let vtable: [UniffiVTableCallbackInterfaceFfiConsentCallback] =
			...
			onError: { (
				...
				let makeCall = {
					...
					return try uniffiObj.onError(
						error: FfiConverterTypeFfiSubscribeError_lift(error)
					)
				}
...
public struct FfiConverterTypeFfiConsentCallback: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConsentCallback {
		FfiConsentCallbackImpl(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiConsentCallback_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConsentCallback {
	try FfiConverterTypeFfiConsentCallback.lift(pointer)
}
...
public func FfiConverterTypeFfiConsentCallback_lower(_ value: FfiConsentCallback) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConsentCallback.lower(value)
}
...
open class FfiConversation: FfiConversationProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonversation(self.pointer, $0) }
	}
	...
	open func addedByInboxId() throws -> String {
		try FfiConverterString.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
			uniffi_xmtpv3_fn_method_fficonversation_added_by_inbox_id(self.uniffiClonePointer(), $0)
		})
	}

	open func adminList() throws -> [String] {
		try FfiConverterSequenceString.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func consentState() throws -> FfiConsentState {
		try FfiConverterTypeFfiConsentState_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func conversationMessageDisappearingSettings() throws -> FfiMessageDisappearingSettings? {
		try FfiConverterOptionTypeFfiMessageDisappearingSettings.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func conversationType() -> FfiConversationType {
		try! FfiConverterTypeFfiConversationType_lift(try! rustCall {
	...
	open func countMessages(opts: FfiListMessagesOptions) throws -> Int64 {
		try FfiConverterInt64.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func findEnrichedMessages(opts: FfiListMessagesOptions) throws -> [FfiDecodedMessage] {
		try FfiConverterSequenceTypeFfiDecodedMessage.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func findMessagesWithReactions(opts: FfiListMessagesOptions) throws -> [FfiMessageWithReactions] {
		try FfiConverterSequenceTypeFfiMessageWithReactions.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
			uniffi_xmtpv3_fn_method_fficonversation_find_messages_with_reactions(self.uniffiClonePointer(),
			                                                                     FfiConverterTypeFfiListMessagesOptions_lower(
			                                                                     	opts
			                                                                     ),
			                                                                     $0)
		})
	...
	open func getHmacKeys() throws -> [Data: [FfiHmacKey]] {
		try FfiConverterDictionaryDataSequenceTypeFfiHmacKey.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func getLastReadTimes() throws -> [String: Int64] {
		try FfiConverterDictionaryStringInt64.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func groupPermissions() throws -> FfiGroupPermissions {
		try FfiConverterTypeFfiGroupPermissions_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func isActive() throws -> Bool {
		try FfiConverterBool.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func pausedForVersion() throws -> String? {
		try FfiConverterOptionString.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func sendOptimistic(contentBytes: Data, opts: FfiSendMessageOpts) throws -> Data {
		try FfiConverterData.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func updateConsentState(state: FfiConsentState) throws {
		try rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func updatePermissionPolicy(
		permissionUpdateType: FfiPermissionUpdateType,
		permissionPolicyOption: FfiPermissionPolicy,
		metadataField: FfiMetadataField?
	) async throws {
		try await uniffiRustCallAsync(
			rustFutureFunc: {
				uniffi_xmtpv3_fn_method_fficonversation_update_permission_policy(
					self.uniffiClonePointer(),
					FfiConverterTypeFfiPermissionUpdateType_lower(permissionUpdateType),
					FfiConverterTypeFfiPermissionPolicy_lower(permissionPolicyOption),
					FfiConverterOptionTypeFfiMetadataField.lower(metadataField)
				)
			},
			pollFunc: ffi_xmtpv3_rust_future_poll_void,
			completeFunc: ffi_xmtpv3_rust_future_complete_void,
...
public struct FfiConverterTypeFfiConversation: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversation {
		FfiConversation(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiConversation_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversation {
	try FfiConverterTypeFfiConversation.lift(pointer)
}
...
public func FfiConverterTypeFfiConversation_lower(_ value: FfiConversation) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConversation.lower(value)
}
...
open class FfiConversationCallbackImpl: FfiConversationCallback, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonversationcallback(self.pointer, $0) }
	}
	...
	open func onConversation(conversation: FfiConversation) { try! rustCall {
		uniffi_xmtpv3_fn_method_fficonversationcallback_on_conversation(self.uniffiClonePointer(),
		                                                                FfiConverterTypeFfiConversation_lower(conversation),
		                                                                $0)
	}
	}
...
private enum UniffiCallbackInterfaceFfiConversationCallback {
	...
	// This creates 1-element array, since this seems to be the only way to construct a const
	// pointer that we can pass to the Rust code.
	static let vtable: [UniffiVTableCallbackInterfaceFfiConversationCallback] =
			...
			onConversation: { (
				...
				let makeCall = {
					...
					return try uniffiObj.onConversation(
						conversation: FfiConverterTypeFfiConversation_lift(conversation)
					)
				}
...
public struct FfiConverterTypeFfiConversationCallback: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversationCallback {
		FfiConversationCallbackImpl(unsafeFromRawPointer: pointer)
	}
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiConversationCallback_lift(_ pointer: UnsafeMutableRawPointer) throws
	-> FfiConversationCallback
{
	try FfiConverterTypeFfiConversationCallback.lift(pointer)
}
...
public func FfiConverterTypeFfiConversationCallback_lower(_ value: FfiConversationCallback) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConversationCallback.lower(value)
}
...
open class FfiConversationListItem: FfiConversationListItemProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonversationlistitem(self.pointer, $0) }
	}
	...
	open func lastMessage() -> FfiMessage? {
		try! FfiConverterOptionTypeFfiMessage.lift(try! rustCall {
...
public struct FfiConverterTypeFfiConversationListItem: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversationListItem {
		FfiConversationListItem(unsafeFromRawPointer: pointer)
	}
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiConversationListItem_lift(_ pointer: UnsafeMutableRawPointer) throws
	-> FfiConversationListItem
{
	try FfiConverterTypeFfiConversationListItem.lift(pointer)
}
...
public func FfiConverterTypeFfiConversationListItem_lower(_ value: FfiConversationListItem) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConversationListItem.lower(value)
}
...
open class FfiConversationMetadata: FfiConversationMetadataProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonversationmetadata(self.pointer, $0) }
	}
...
public struct FfiConverterTypeFfiConversationMetadata: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversationMetadata {
		FfiConversationMetadata(unsafeFromRawPointer: pointer)
	}
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiConversationMetadata_lift(_ pointer: UnsafeMutableRawPointer) throws
	-> FfiConversationMetadata
{
	try FfiConverterTypeFfiConversationMetadata.lift(pointer)
}
...
public func FfiConverterTypeFfiConversationMetadata_lower(_ value: FfiConversationMetadata) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConversationMetadata.lower(value)
}
...
public protocol FfiConversationsProtocol: AnyObject, Sendable {
	...
	func streamAllDmMessages(messageCallback: FfiMessageCallback, consentStates: [FfiConsentState]?) async
		-> FfiStreamCloser

	func streamAllGroupMessages(messageCallback: FfiMessageCallback, consentStates: [FfiConsentState]?) async
		-> FfiStreamCloser
...
open class FfiConversations: FfiConversationsProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_fficonversations(self.pointer, $0) }
	}
	...
	open func createGroup(accountIdentities: [FfiIdentifier],
	                      opts: FfiCreateGroupOptions) async throws -> FfiConversation
	{
		try await uniffiRustCallAsync(
			rustFutureFunc: {
	...
	open func createGroupOptimistic(opts: FfiCreateGroupOptions) throws -> FfiConversation {
		try FfiConverterTypeFfiConversation_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
			uniffi_xmtpv3_fn_method_fficonversations_create_group_optimistic(self.uniffiClonePointer(),
			                                                                 FfiConverterTypeFfiCreateGroupOptions_lower(opts),
			                                                                 $0)
		})
	}
	...
	open func list(opts: FfiListConversationsOptions) throws -> [FfiConversationListItem] {
		try FfiConverterSequenceTypeFfiConversationListItem.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func streamAllDmMessages(messageCallback: FfiMessageCallback,
	                              consentStates: [FfiConsentState]?) async -> FfiStreamCloser
	{
		try! await uniffiRustCallAsync(
			rustFutureFunc: {
	...
	open func streamAllGroupMessages(messageCallback: FfiMessageCallback,
	                                 consentStates: [FfiConsentState]?) async -> FfiStreamCloser
	{
		try! await uniffiRustCallAsync(
			rustFutureFunc: {
	...
	open func streamAllMessages(messageCallback: FfiMessageCallback,
	                            consentStates: [FfiConsentState]?) async -> FfiStreamCloser
	{
		try! await uniffiRustCallAsync(
			rustFutureFunc: {
		...
		try! await uniffiRustCallAsync(
			rustFutureFunc: {
				uniffi_xmtpv3_fn_method_fficonversations_stream_messages(
					self.uniffiClonePointer(),
					FfiConverterTypeFfiMessageCallback_lower(messageCallback),
					FfiConverterOptionTypeFfiConversationType.lower(conversationType),
					FfiConverterOptionSequenceTypeFfiConsentState.lower(consentStates)
				)
			},
			pollFunc: ffi_xmtpv3_rust_future_poll_pointer,
...
public struct FfiConverterTypeFfiConversations: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversations {
		FfiConversations(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiConversations_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiConversations {
	try FfiConverterTypeFfiConversations.lift(pointer)
}
...
public func FfiConverterTypeFfiConversations_lower(_ value: FfiConversations) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiConversations.lower(value)
}
...
open class FfiDecodedMessage: FfiDecodedMessageProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffidecodedmessage(self.pointer, $0) }
	}
	...
	open func content() -> FfiDecodedMessageContent {
		try! FfiConverterTypeFfiDecodedMessageContent_lift(try! rustCall {
			uniffi_xmtpv3_fn_method_ffidecodedmessage_content(self.uniffiClonePointer(), $0)
		})
	}

	open func contentTypeId() -> FfiContentTypeId {
		try! FfiConverterTypeFfiContentTypeId_lift(try! rustCall {
	...
	open func deliveryStatus() -> FfiDeliveryStatus {
		try! FfiConverterTypeFfiDeliveryStatus_lift(try! rustCall {
	...
	open func kind() -> FfiGroupMessageKind {
		try! FfiConverterTypeFfiGroupMessageKind_lift(try! rustCall {
	...
	open func reactions() -> [FfiDecodedMessage] {
		try! FfiConverterSequenceTypeFfiDecodedMessage.lift(try! rustCall {
...
public struct FfiConverterTypeFfiDecodedMessage: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiDecodedMessage {
		FfiDecodedMessage(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiDecodedMessage_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiDecodedMessage {
	try FfiConverterTypeFfiDecodedMessage.lift(pointer)
}
...
public func FfiConverterTypeFfiDecodedMessage_lower(_ value: FfiDecodedMessage) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiDecodedMessage.lower(value)
}
...
open class FfiGroupPermissions: FfiGroupPermissionsProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffigrouppermissions(self.pointer, $0) }
	}
	...
	open func policySet() throws -> FfiPermissionPolicySet {
		try FfiConverterTypeFfiPermissionPolicySet_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func policyType() throws -> FfiGroupPermissionsOptions {
		try FfiConverterTypeFfiGroupPermissionsOptions_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public struct FfiConverterTypeFfiGroupPermissions: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiGroupPermissions {
		FfiGroupPermissions(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiGroupPermissions_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiGroupPermissions {
	try FfiConverterTypeFfiGroupPermissions.lift(pointer)
}
...
public func FfiConverterTypeFfiGroupPermissions_lower(_ value: FfiGroupPermissions) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiGroupPermissions.lower(value)
}
...
open class FfiInboxOwnerImpl: FfiInboxOwner, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffiinboxowner(self.pointer, $0) }
	}
	...
	open func getIdentifier() throws -> FfiIdentifier {
		try FfiConverterTypeFfiIdentifier_lift(rustCallWithError(FfiConverterTypeIdentityValidationError_lift) {
			uniffi_xmtpv3_fn_method_ffiinboxowner_get_identifier(self.uniffiClonePointer(), $0)
		})
	}

	open func sign(text: String) throws -> Data {
		try FfiConverterData.lift(rustCallWithError(FfiConverterTypeSigningError_lift) {
...
public struct FfiConverterTypeFfiInboxOwner: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiInboxOwner {
		FfiInboxOwnerImpl(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiInboxOwner_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiInboxOwner {
	try FfiConverterTypeFfiInboxOwner.lift(pointer)
}
...
public func FfiConverterTypeFfiInboxOwner_lower(_ value: FfiInboxOwner) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiInboxOwner.lower(value)
}
...
open class FfiMessageCallbackImpl: FfiMessageCallback, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffimessagecallback(self.pointer, $0) }
	}
...
private enum UniffiCallbackInterfaceFfiMessageCallback {
	...
	// This creates 1-element array, since this seems to be the only way to construct a const
	// pointer that we can pass to the Rust code.
	static let vtable: [UniffiVTableCallbackInterfaceFfiMessageCallback] =
			...
			onMessage: { (
				...
				let makeCall = {
					...
					return try uniffiObj.onMessage(
						message: FfiConverterTypeFfiMessage_lift(message)
					)
				}
...
public struct FfiConverterTypeFfiMessageCallback: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiMessageCallback {
		FfiMessageCallbackImpl(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiMessageCallback_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiMessageCallback {
	try FfiConverterTypeFfiMessageCallback.lift(pointer)
}
...
public func FfiConverterTypeFfiMessageCallback_lower(_ value: FfiMessageCallback) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiMessageCallback.lower(value)
}
...
open class FfiMessageDeletionCallbackImpl: FfiMessageDeletionCallback, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffimessagedeletioncallback(self.pointer, $0) }
	}
...
// Put the implementation in a struct so we don't pollute the top-level namespace
private enum UniffiCallbackInterfaceFfiMessageDeletionCallback {
	// Create the VTable using a series of closures.
	// Swift automatically converts these into C callback functions.
	//
	// This creates 1-element array, since this seems to be the only way to construct a const
	// pointer that we can pass to the Rust code.
	static let vtable: [UniffiVTableCallbackInterfaceFfiMessageDeletionCallback] =
		[UniffiVTableCallbackInterfaceFfiMessageDeletionCallback(
			onMessageDeleted: { (
				...
				let makeCall = {
					...
					return try uniffiObj.onMessageDeleted(
						messageId: FfiConverterData.lift(messageId)
					)
				}
...
private func uniffiCallbackInitFfiMessageDeletionCallback() {
	uniffi_xmtpv3_fn_init_callback_vtable_ffimessagedeletioncallback(UniffiCallbackInterfaceFfiMessageDeletionCallback
		.vtable)
}
...
public struct FfiConverterTypeFfiMessageDeletionCallback: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiMessageDeletionCallback {
		FfiMessageDeletionCallbackImpl(unsafeFromRawPointer: pointer)
	}
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiMessageDeletionCallback_lift(_ pointer: UnsafeMutableRawPointer) throws
	-> FfiMessageDeletionCallback
{
	try FfiConverterTypeFfiMessageDeletionCallback.lift(pointer)
}

#if swift(>=5.8)
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiMessageDeletionCallback_lower(_ value: FfiMessageDeletionCallback)
	-> UnsafeMutableRawPointer
{
	FfiConverterTypeFfiMessageDeletionCallback.lower(value)
}
...
open class FfiPreferenceCallbackImpl: FfiPreferenceCallback, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffipreferencecallback(self.pointer, $0) }
	}
	...
	open func onPreferenceUpdate(preference: [FfiPreferenceUpdate]) { try! rustCall {
		uniffi_xmtpv3_fn_method_ffipreferencecallback_on_preference_update(self.uniffiClonePointer(),
		                                                                   FfiConverterSequenceTypeFfiPreferenceUpdate
		                                                                   	.lower(preference), $0)
	}
	}
...
private enum UniffiCallbackInterfaceFfiPreferenceCallback {
	...
	// This creates 1-element array, since this seems to be the only way to construct a const
	// pointer that we can pass to the Rust code.
	static let vtable: [UniffiVTableCallbackInterfaceFfiPreferenceCallback] =
...
public struct FfiConverterTypeFfiPreferenceCallback: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiPreferenceCallback {
		FfiPreferenceCallbackImpl(unsafeFromRawPointer: pointer)
	}
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiPreferenceCallback_lift(_ pointer: UnsafeMutableRawPointer) throws
	-> FfiPreferenceCallback
{
	try FfiConverterTypeFfiPreferenceCallback.lift(pointer)
}
...
public func FfiConverterTypeFfiPreferenceCallback_lower(_ value: FfiPreferenceCallback) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiPreferenceCallback.lower(value)
}
...
open class FfiSignatureRequest: FfiSignatureRequestProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffisignaturerequest(self.pointer, $0) }
	}
		...
		try await uniffiRustCallAsync(
			rustFutureFunc: {
				uniffi_xmtpv3_fn_method_ffisignaturerequest_add_scw_signature(
					self.uniffiClonePointer(),
					FfiConverterData.lower(signatureBytes), FfiConverterString.lower(address), FfiConverterUInt64.lower(chainId),
					FfiConverterOptionUInt64.lower(blockNumber)
				)
			},
			pollFunc: ffi_xmtpv3_rust_future_poll_void,
			completeFunc: ffi_xmtpv3_rust_future_complete_void,
...
public struct FfiConverterTypeFfiSignatureRequest: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiSignatureRequest {
		FfiSignatureRequest(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiSignatureRequest_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiSignatureRequest {
	try FfiConverterTypeFfiSignatureRequest.lift(pointer)
}
...
public func FfiConverterTypeFfiSignatureRequest_lower(_ value: FfiSignatureRequest) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiSignatureRequest.lower(value)
}
...
open class FfiStreamCloser: FfiStreamCloserProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffistreamcloser(self.pointer, $0) }
	}
...
public struct FfiConverterTypeFfiStreamCloser: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiStreamCloser {
		FfiStreamCloser(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiStreamCloser_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiStreamCloser {
	try FfiConverterTypeFfiStreamCloser.lift(pointer)
}
...
public func FfiConverterTypeFfiStreamCloser_lower(_ value: FfiStreamCloser) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiStreamCloser.lower(value)
}
...
open class FfiSyncWorker: FfiSyncWorkerProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffisyncworker(self.pointer, $0) }
	}
...
public struct FfiConverterTypeFfiSyncWorker: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiSyncWorker {
		FfiSyncWorker(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiSyncWorker_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiSyncWorker {
	try FfiConverterTypeFfiSyncWorker.lift(pointer)
}
...
public func FfiConverterTypeFfiSyncWorker_lower(_ value: FfiSyncWorker) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiSyncWorker.lower(value)
}
...
open class FfiXmtpClient: FfiXmtpClientProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_ffixmtpclient(self.pointer, $0) }
	}
	...
	open func apiIdentityStatistics() -> FfiIdentityStats {
		try! FfiConverterTypeFfiIdentityStats_lift(try! rustCall {
	...
	open func apiStatistics() -> FfiApiStats {
		try! FfiConverterTypeFfiApiStats_lift(try! rustCall {
	...
	open func conversations() -> FfiConversations {
		try! FfiConverterTypeFfiConversations_lift(try! rustCall {
	...
	open func deleteMessage(messageId: Data) throws -> UInt32 {
		try FfiConverterUInt32.lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func enrichedMessage(messageId: Data) throws -> FfiDecodedMessage {
		try FfiConverterTypeFfiDecodedMessage_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func getKeyPackageStatusesForInstallationIds(installationIds: [Data]) async throws
		-> [Data: FfiKeyPackageStatus]
	{
		try await uniffiRustCallAsync(
			rustFutureFunc: {
	...
	open func message(messageId: Data) throws -> FfiMessage {
		try FfiConverterTypeFfiMessage_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
	...
	open func signatureRequest() -> FfiSignatureRequest? {
		try! FfiConverterOptionTypeFfiSignatureRequest.lift(try! rustCall {
	 ...
	 * A utility function to easily verify that a piece of text was signed by this installation.
	 */
	open func verifySignedWithInstallationKey(signatureText: String, signatureBytes: Data) throws {
		try rustCallWithError(FfiConverterTypeGenericError_lift) {
	 ...
	 * Only works for verifying libXmtp public context signatures.
	 */
	open func verifySignedWithPublicKey(signatureText: String, signatureBytes: Data, publicKey: Data) throws {
		try rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public struct FfiConverterTypeFfiXmtpClient: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiXmtpClient {
		FfiXmtpClient(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeFfiXmtpClient_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiXmtpClient {
	try FfiConverterTypeFfiXmtpClient.lift(pointer)
}
...
public func FfiConverterTypeFfiXmtpClient_lower(_ value: FfiXmtpClient) -> UnsafeMutableRawPointer {
	FfiConverterTypeFfiXmtpClient.lower(value)
}
...
open class XmtpApiClient: XmtpApiClientProtocol, @unchecked Sendable {
	...
	#endif
	public func uniffiClonePointer() -> UnsafeMutableRawPointer {
		try! rustCall { uniffi_xmtpv3_fn_clone_xmtpapiclient(self.pointer, $0) }
	}
...
public struct FfiConverterTypeXmtpApiClient: FfiConverter {
	...
	public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> XmtpApiClient {
		XmtpApiClient(unsafeFromRawPointer: pointer)
	}
...
public func FfiConverterTypeXmtpApiClient_lift(_ pointer: UnsafeMutableRawPointer) throws -> XmtpApiClient {
	try FfiConverterTypeXmtpApiClient.lift(pointer)
}
...
public func FfiConverterTypeXmtpApiClient_lower(_ value: XmtpApiClient) -> UnsafeMutableRawPointer {
	FfiConverterTypeXmtpApiClient.lower(value)
}
...
public func FfiConverterTypeFfiAction_lift(_ buf: RustBuffer) throws -> FfiAction {
	try FfiConverterTypeFfiAction.lift(buf)
}
...
public func FfiConverterTypeFfiAction_lower(_ value: FfiAction) -> RustBuffer {
	FfiConverterTypeFfiAction.lower(value)
}
...
public func FfiConverterTypeFfiActions_lift(_ buf: RustBuffer) throws -> FfiActions {
	try FfiConverterTypeFfiActions.lift(buf)
}
...
public func FfiConverterTypeFfiActions_lower(_ value: FfiActions) -> RustBuffer {
	FfiConverterTypeFfiActions.lower(value)
}
...
public struct FfiApiStats {
	...
	// declare one manually.
	public init(
		uploadKeyPackage: UInt64,
		fetchKeyPackage: UInt64,
		sendGroupMessages: UInt64,
		sendWelcomeMessages: UInt64,
		queryGroupMessages: UInt64,
		queryWelcomeMessages: UInt64,
		subscribeMessages: UInt64,
		subscribeWelcomes: UInt64
	) {
...
public func FfiConverterTypeFfiApiStats_lift(_ buf: RustBuffer) throws -> FfiApiStats {
	try FfiConverterTypeFfiApiStats.lift(buf)
}
...
public func FfiConverterTypeFfiApiStats_lower(_ value: FfiApiStats) -> RustBuffer {
	FfiConverterTypeFfiApiStats.lower(value)
}
...
public func FfiConverterTypeFfiArchiveOptions_lift(_ buf: RustBuffer) throws -> FfiArchiveOptions {
	try FfiConverterTypeFfiArchiveOptions.lift(buf)
}
...
public func FfiConverterTypeFfiArchiveOptions_lower(_ value: FfiArchiveOptions) -> RustBuffer {
	FfiConverterTypeFfiArchiveOptions.lower(value)
}
...
public func FfiConverterTypeFfiAttachment_lift(_ buf: RustBuffer) throws -> FfiAttachment {
	try FfiConverterTypeFfiAttachment.lift(buf)
}
...
public func FfiConverterTypeFfiAttachment_lower(_ value: FfiAttachment) -> RustBuffer {
	FfiConverterTypeFfiAttachment.lower(value)
}
...
public struct FfiBackupMetadata {
	...
	// declare one manually.
	public init(
		backupVersion: UInt16,
		elements: [FfiBackupElementSelection],
		exportedAtNs: Int64,
		startNs: Int64?,
		endNs: Int64?
	) {
...
public func FfiConverterTypeFfiBackupMetadata_lift(_ buf: RustBuffer) throws -> FfiBackupMetadata {
	try FfiConverterTypeFfiBackupMetadata.lift(buf)
}
...
public func FfiConverterTypeFfiBackupMetadata_lower(_ value: FfiBackupMetadata) -> RustBuffer {
	FfiConverterTypeFfiBackupMetadata.lower(value)
}
...
public func FfiConverterTypeFfiConsent_lift(_ buf: RustBuffer) throws -> FfiConsent {
	try FfiConverterTypeFfiConsent.lift(buf)
}
...
public func FfiConverterTypeFfiConsent_lower(_ value: FfiConsent) -> RustBuffer {
	FfiConverterTypeFfiConsent.lower(value)
}
...
public func FfiConverterTypeFfiContentTypeId_lift(_ buf: RustBuffer) throws -> FfiContentTypeId {
	try FfiConverterTypeFfiContentTypeId.lift(buf)
}
...
public func FfiConverterTypeFfiContentTypeId_lower(_ value: FfiContentTypeId) -> RustBuffer {
	FfiConverterTypeFfiContentTypeId.lower(value)
}
...
public func FfiConverterTypeFfiConversationDebugInfo_lift(_ buf: RustBuffer) throws -> FfiConversationDebugInfo {
	try FfiConverterTypeFfiConversationDebugInfo.lift(buf)
}
...
public func FfiConverterTypeFfiConversationDebugInfo_lower(_ value: FfiConversationDebugInfo) -> RustBuffer {
	FfiConverterTypeFfiConversationDebugInfo.lower(value)
}
...
public struct FfiConversationMember {
	...
	public init(
		inboxId: String,
		accountIdentifiers: [FfiIdentifier],
		installationIds: [Data],
...
public func FfiConverterTypeFfiConversationMember_lift(_ buf: RustBuffer) throws -> FfiConversationMember {
	try FfiConverterTypeFfiConversationMember.lift(buf)
}
...
public func FfiConverterTypeFfiConversationMember_lower(_ value: FfiConversationMember) -> RustBuffer {
	FfiConverterTypeFfiConversationMember.lower(value)
}
...
public func FfiConverterTypeFfiCreateDMOptions_lift(_ buf: RustBuffer) throws -> FfiCreateDmOptions {
	try FfiConverterTypeFfiCreateDMOptions.lift(buf)
}
...
public func FfiConverterTypeFfiCreateDMOptions_lower(_ value: FfiCreateDmOptions) -> RustBuffer {
	FfiConverterTypeFfiCreateDMOptions.lower(value)
}
...
public struct FfiCreateGroupOptions {
	...
	public init(
		...
		customPermissionPolicySet: FfiPermissionPolicySet?,
...
public func FfiConverterTypeFfiCreateGroupOptions_lift(_ buf: RustBuffer) throws -> FfiCreateGroupOptions {
	try FfiConverterTypeFfiCreateGroupOptions.lift(buf)
}
...
public func FfiConverterTypeFfiCreateGroupOptions_lower(_ value: FfiCreateGroupOptions) -> RustBuffer {
	FfiConverterTypeFfiCreateGroupOptions.lower(value)
}
...
public func FfiConverterTypeFfiCursor_lift(_ buf: RustBuffer) throws -> FfiCursor {
	try FfiConverterTypeFfiCursor.lift(buf)
}
...
public func FfiConverterTypeFfiCursor_lower(_ value: FfiCursor) -> RustBuffer {
	FfiConverterTypeFfiCursor.lower(value)
}
...
public func FfiConverterTypeFfiDecodedMessageMetadata_lift(_ buf: RustBuffer) throws -> FfiDecodedMessageMetadata {
	try FfiConverterTypeFfiDecodedMessageMetadata.lift(buf)
}
...
public func FfiConverterTypeFfiDecodedMessageMetadata_lower(_ value: FfiDecodedMessageMetadata) -> RustBuffer {
	FfiConverterTypeFfiDecodedMessageMetadata.lower(value)
}
...
public func FfiConverterTypeFfiEncodedContent_lift(_ buf: RustBuffer) throws -> FfiEncodedContent {
	try FfiConverterTypeFfiEncodedContent.lift(buf)
}
...
public func FfiConverterTypeFfiEncodedContent_lower(_ value: FfiEncodedContent) -> RustBuffer {
	FfiConverterTypeFfiEncodedContent.lower(value)
}
...
public func FfiConverterTypeFfiEnrichedReply_lift(_ buf: RustBuffer) throws -> FfiEnrichedReply {
	try FfiConverterTypeFfiEnrichedReply.lift(buf)
}
...
public func FfiConverterTypeFfiEnrichedReply_lower(_ value: FfiEnrichedReply) -> RustBuffer {
	FfiConverterTypeFfiEnrichedReply.lower(value)
}
...
public func FfiConverterTypeFfiForkRecoveryOpts_lift(_ buf: RustBuffer) throws -> FfiForkRecoveryOpts {
	try FfiConverterTypeFfiForkRecoveryOpts.lift(buf)
}
...
public func FfiConverterTypeFfiForkRecoveryOpts_lower(_ value: FfiForkRecoveryOpts) -> RustBuffer {
	FfiConverterTypeFfiForkRecoveryOpts.lower(value)
}
...
public func FfiConverterTypeFfiGroupSyncSummary_lift(_ buf: RustBuffer) throws -> FfiGroupSyncSummary {
	try FfiConverterTypeFfiGroupSyncSummary.lift(buf)
}
...
public func FfiConverterTypeFfiGroupSyncSummary_lower(_ value: FfiGroupSyncSummary) -> RustBuffer {
	FfiConverterTypeFfiGroupSyncSummary.lower(value)
}
...
public struct FfiGroupUpdated {
	...
	public init(
		...
		addedInboxes: [FfiInbox],
		removedInboxes: [FfiInbox],
		leftInboxes: [FfiInbox],
		metadataFieldChanges: [FfiMetadataFieldChange]
	) {
...
public func FfiConverterTypeFfiGroupUpdated_lift(_ buf: RustBuffer) throws -> FfiGroupUpdated {
	try FfiConverterTypeFfiGroupUpdated.lift(buf)
}
...
public func FfiConverterTypeFfiGroupUpdated_lower(_ value: FfiGroupUpdated) -> RustBuffer {
	FfiConverterTypeFfiGroupUpdated.lower(value)
}
...
public func FfiConverterTypeFfiHmacKey_lift(_ buf: RustBuffer) throws -> FfiHmacKey {
	try FfiConverterTypeFfiHmacKey.lift(buf)
}
...
public func FfiConverterTypeFfiHmacKey_lower(_ value: FfiHmacKey) -> RustBuffer {
	FfiConverterTypeFfiHmacKey.lower(value)
}
...
public func FfiConverterTypeFfiIdentifier_lift(_ buf: RustBuffer) throws -> FfiIdentifier {
	try FfiConverterTypeFfiIdentifier.lift(buf)
}
...
public func FfiConverterTypeFfiIdentifier_lower(_ value: FfiIdentifier) -> RustBuffer {
	FfiConverterTypeFfiIdentifier.lower(value)
}
...
public struct FfiIdentityStats {
	...
	// declare one manually.
	public init(
		publishIdentityUpdate: UInt64,
		getIdentityUpdatesV2: UInt64,
		getInboxIds: UInt64,
		verifySmartContractWalletSignature: UInt64
	) {
...
public func FfiConverterTypeFfiIdentityStats_lift(_ buf: RustBuffer) throws -> FfiIdentityStats {
	try FfiConverterTypeFfiIdentityStats.lift(buf)
}
...
public func FfiConverterTypeFfiIdentityStats_lower(_ value: FfiIdentityStats) -> RustBuffer {
	FfiConverterTypeFfiIdentityStats.lower(value)
}
...
public func FfiConverterTypeFfiInbox_lift(_ buf: RustBuffer) throws -> FfiInbox {
	try FfiConverterTypeFfiInbox.lift(buf)
}
...
public func FfiConverterTypeFfiInbox_lower(_ value: FfiInbox) -> RustBuffer {
	FfiConverterTypeFfiInbox.lower(value)
}
...
public struct FfiInboxState {
	...
	public init(
		...
		installations: [FfiInstallation],
		accountIdentities: [FfiIdentifier],
		creationSignatureKind: FfiSignatureKind?
	) {
		self.inboxId = inboxId
...
public func FfiConverterTypeFfiInboxState_lift(_ buf: RustBuffer) throws -> FfiInboxState {
	try FfiConverterTypeFfiInboxState.lift(buf)
}
...
public func FfiConverterTypeFfiInboxState_lower(_ value: FfiInboxState) -> RustBuffer {
	FfiConverterTypeFfiInboxState.lower(value)
}
...
public func FfiConverterTypeFfiInstallation_lift(_ buf: RustBuffer) throws -> FfiInstallation {
	try FfiConverterTypeFfiInstallation.lift(buf)
}
...
public func FfiConverterTypeFfiInstallation_lower(_ value: FfiInstallation) -> RustBuffer {
	FfiConverterTypeFfiInstallation.lower(value)
}
...
public func FfiConverterTypeFfiIntent_lift(_ buf: RustBuffer) throws -> FfiIntent {
	try FfiConverterTypeFfiIntent.lift(buf)
}
...
public func FfiConverterTypeFfiIntent_lower(_ value: FfiIntent) -> RustBuffer {
	FfiConverterTypeFfiIntent.lower(value)
}
...
public func FfiConverterTypeFfiKeyPackageStatus_lift(_ buf: RustBuffer) throws -> FfiKeyPackageStatus {
	try FfiConverterTypeFfiKeyPackageStatus.lift(buf)
}
...
public func FfiConverterTypeFfiKeyPackageStatus_lower(_ value: FfiKeyPackageStatus) -> RustBuffer {
	FfiConverterTypeFfiKeyPackageStatus.lower(value)
}
...
public func FfiConverterTypeFfiLifetime_lift(_ buf: RustBuffer) throws -> FfiLifetime {
	try FfiConverterTypeFfiLifetime.lift(buf)
}
...
public func FfiConverterTypeFfiLifetime_lower(_ value: FfiLifetime) -> RustBuffer {
	FfiConverterTypeFfiLifetime.lower(value)
}
...
public func FfiConverterTypeFfiListConversationsOptions_lift(_ buf: RustBuffer) throws -> FfiListConversationsOptions {
	try FfiConverterTypeFfiListConversationsOptions.lift(buf)
}
...
public func FfiConverterTypeFfiListConversationsOptions_lower(_ value: FfiListConversationsOptions) -> RustBuffer {
	FfiConverterTypeFfiListConversationsOptions.lower(value)
}
...
public struct FfiListMessagesOptions {
	...
	public init(
		...
		contentTypes: [FfiContentType]?,
		excludeContentTypes: [FfiContentType]?,
...
public func FfiConverterTypeFfiListMessagesOptions_lift(_ buf: RustBuffer) throws -> FfiListMessagesOptions {
	try FfiConverterTypeFfiListMessagesOptions.lift(buf)
}
...
public func FfiConverterTypeFfiListMessagesOptions_lower(_ value: FfiListMessagesOptions) -> RustBuffer {
	FfiConverterTypeFfiListMessagesOptions.lower(value)
}
...
public func FfiConverterTypeFfiMessage_lift(_ buf: RustBuffer) throws -> FfiMessage {
	try FfiConverterTypeFfiMessage.lift(buf)
}
...
public func FfiConverterTypeFfiMessage_lower(_ value: FfiMessage) -> RustBuffer {
	FfiConverterTypeFfiMessage.lower(value)
}
...
public struct FfiConverterTypeFfiMessageDisappearingSettings: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiMessageDisappearingSettings_lift(_ buf: RustBuffer) throws
	-> FfiMessageDisappearingSettings
{
	try FfiConverterTypeFfiMessageDisappearingSettings.lift(buf)
}

#if swift(>=5.8)
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiMessageDisappearingSettings_lower(_ value: FfiMessageDisappearingSettings)
	-> RustBuffer
{
	FfiConverterTypeFfiMessageDisappearingSettings.lower(value)
}
...
public func FfiConverterTypeFfiMessageWithReactions_lift(_ buf: RustBuffer) throws -> FfiMessageWithReactions {
	try FfiConverterTypeFfiMessageWithReactions.lift(buf)
}
...
public func FfiConverterTypeFfiMessageWithReactions_lower(_ value: FfiMessageWithReactions) -> RustBuffer {
	FfiConverterTypeFfiMessageWithReactions.lower(value)
}
...
public func FfiConverterTypeFfiMetadataFieldChange_lift(_ buf: RustBuffer) throws -> FfiMetadataFieldChange {
	try FfiConverterTypeFfiMetadataFieldChange.lift(buf)
}
...
public func FfiConverterTypeFfiMetadataFieldChange_lower(_ value: FfiMetadataFieldChange) -> RustBuffer {
	FfiConverterTypeFfiMetadataFieldChange.lower(value)
}
...
public func FfiConverterTypeFfiMultiRemoteAttachment_lift(_ buf: RustBuffer) throws -> FfiMultiRemoteAttachment {
	try FfiConverterTypeFfiMultiRemoteAttachment.lift(buf)
}
...
public func FfiConverterTypeFfiMultiRemoteAttachment_lower(_ value: FfiMultiRemoteAttachment) -> RustBuffer {
	FfiConverterTypeFfiMultiRemoteAttachment.lower(value)
}
...
public func FfiConverterTypeFfiPasskeySignature_lift(_ buf: RustBuffer) throws -> FfiPasskeySignature {
	try FfiConverterTypeFfiPasskeySignature.lift(buf)
}
...
public func FfiConverterTypeFfiPasskeySignature_lower(_ value: FfiPasskeySignature) -> RustBuffer {
	FfiConverterTypeFfiPasskeySignature.lower(value)
}
...
public func FfiConverterTypeFfiPermissionPolicySet_lift(_ buf: RustBuffer) throws -> FfiPermissionPolicySet {
	try FfiConverterTypeFfiPermissionPolicySet.lift(buf)
}
...
public func FfiConverterTypeFfiPermissionPolicySet_lower(_ value: FfiPermissionPolicySet) -> RustBuffer {
	FfiConverterTypeFfiPermissionPolicySet.lower(value)
}
...
public func FfiConverterTypeFfiReactionPayload_lift(_ buf: RustBuffer) throws -> FfiReactionPayload {
	try FfiConverterTypeFfiReactionPayload.lift(buf)
}
...
public func FfiConverterTypeFfiReactionPayload_lower(_ value: FfiReactionPayload) -> RustBuffer {
	FfiConverterTypeFfiReactionPayload.lower(value)
}
...
extension FfiReadReceipt: Equatable, Hashable {
	public static func == (_: FfiReadReceipt, _: FfiReadReceipt) -> Bool {
		true
	}
...
public struct FfiConverterTypeFfiReadReceipt: FfiConverterRustBuffer {
	public static func read(from _: inout (data: Data, offset: Data.Index)) throws -> FfiReadReceipt {
		FfiReadReceipt()
	}

	public static func write(_: FfiReadReceipt, into _: inout [UInt8]) {}
}
...
public func FfiConverterTypeFfiReadReceipt_lift(_ buf: RustBuffer) throws -> FfiReadReceipt {
	try FfiConverterTypeFfiReadReceipt.lift(buf)
}
...
public func FfiConverterTypeFfiReadReceipt_lower(_ value: FfiReadReceipt) -> RustBuffer {
	FfiConverterTypeFfiReadReceipt.lower(value)
}
...
public func FfiConverterTypeFfiRemoteAttachment_lift(_ buf: RustBuffer) throws -> FfiRemoteAttachment {
	try FfiConverterTypeFfiRemoteAttachment.lift(buf)
}
...
public func FfiConverterTypeFfiRemoteAttachment_lower(_ value: FfiRemoteAttachment) -> RustBuffer {
	FfiConverterTypeFfiRemoteAttachment.lower(value)
}
...
public func FfiConverterTypeFfiRemoteAttachmentInfo_lift(_ buf: RustBuffer) throws -> FfiRemoteAttachmentInfo {
	try FfiConverterTypeFfiRemoteAttachmentInfo.lift(buf)
}
...
public func FfiConverterTypeFfiRemoteAttachmentInfo_lower(_ value: FfiRemoteAttachmentInfo) -> RustBuffer {
	FfiConverterTypeFfiRemoteAttachmentInfo.lower(value)
}
...
public func FfiConverterTypeFfiReply_lift(_ buf: RustBuffer) throws -> FfiReply {
	try FfiConverterTypeFfiReply.lift(buf)
}
...
public func FfiConverterTypeFfiReply_lower(_ value: FfiReply) -> RustBuffer {
	FfiConverterTypeFfiReply.lower(value)
}
...
public func FfiConverterTypeFfiSendMessageOpts_lift(_ buf: RustBuffer) throws -> FfiSendMessageOpts {
	try FfiConverterTypeFfiSendMessageOpts.lift(buf)
}
...
public func FfiConverterTypeFfiSendMessageOpts_lower(_ value: FfiSendMessageOpts) -> RustBuffer {
	FfiConverterTypeFfiSendMessageOpts.lower(value)
}
...
public func FfiConverterTypeFfiTextContent_lift(_ buf: RustBuffer) throws -> FfiTextContent {
	try FfiConverterTypeFfiTextContent.lift(buf)
}
...
public func FfiConverterTypeFfiTextContent_lower(_ value: FfiTextContent) -> RustBuffer {
	FfiConverterTypeFfiTextContent.lower(value)
}
...
public func FfiConverterTypeFfiTransactionMetadata_lift(_ buf: RustBuffer) throws -> FfiTransactionMetadata {
	try FfiConverterTypeFfiTransactionMetadata.lift(buf)
}
...
public func FfiConverterTypeFfiTransactionMetadata_lower(_ value: FfiTransactionMetadata) -> RustBuffer {
	FfiConverterTypeFfiTransactionMetadata.lower(value)
}
...
public func FfiConverterTypeFfiTransactionReference_lift(_ buf: RustBuffer) throws -> FfiTransactionReference {
	try FfiConverterTypeFfiTransactionReference.lift(buf)
}
...
public func FfiConverterTypeFfiTransactionReference_lower(_ value: FfiTransactionReference) -> RustBuffer {
	FfiConverterTypeFfiTransactionReference.lower(value)
}
...
public struct FfiConverterTypeFfiUpdateGroupMembershipResult: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiUpdateGroupMembershipResult_lift(_ buf: RustBuffer) throws
	-> FfiUpdateGroupMembershipResult
{
	try FfiConverterTypeFfiUpdateGroupMembershipResult.lift(buf)
}

#if swift(>=5.8)
	@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfiUpdateGroupMembershipResult_lower(_ value: FfiUpdateGroupMembershipResult)
	-> RustBuffer
{
	FfiConverterTypeFfiUpdateGroupMembershipResult.lower(value)
}
...
public func FfiConverterTypeFfiWalletCall_lift(_ buf: RustBuffer) throws -> FfiWalletCall {
	try FfiConverterTypeFfiWalletCall.lift(buf)
}
...
public func FfiConverterTypeFfiWalletCall_lower(_ value: FfiWalletCall) -> RustBuffer {
	FfiConverterTypeFfiWalletCall.lower(value)
}
...
public func FfiConverterTypeFfiWalletCallMetadata_lift(_ buf: RustBuffer) throws -> FfiWalletCallMetadata {
	try FfiConverterTypeFfiWalletCallMetadata.lift(buf)
}
...
public func FfiConverterTypeFfiWalletCallMetadata_lower(_ value: FfiWalletCallMetadata) -> RustBuffer {
	FfiConverterTypeFfiWalletCallMetadata.lower(value)
}
...
public func FfiConverterTypeFfiWalletSendCalls_lift(_ buf: RustBuffer) throws -> FfiWalletSendCalls {
	try FfiConverterTypeFfiWalletSendCalls.lift(buf)
}
...
public func FfiConverterTypeFfiWalletSendCalls_lower(_ value: FfiWalletSendCalls) -> RustBuffer {
	FfiConverterTypeFfiWalletSendCalls.lower(value)
}
...
public func FfiConverterTypeFfiActionStyle_lift(_ buf: RustBuffer) throws -> FfiActionStyle {
	try FfiConverterTypeFfiActionStyle.lift(buf)
}
...
public func FfiConverterTypeFfiActionStyle_lower(_ value: FfiActionStyle) -> RustBuffer {
	FfiConverterTypeFfiActionStyle.lower(value)
}
...
public func FfiConverterTypeFfiBackupElementSelection_lift(_ buf: RustBuffer) throws -> FfiBackupElementSelection {
	try FfiConverterTypeFfiBackupElementSelection.lift(buf)
}
...
public func FfiConverterTypeFfiBackupElementSelection_lower(_ value: FfiBackupElementSelection) -> RustBuffer {
	FfiConverterTypeFfiBackupElementSelection.lower(value)
}
...
public func FfiConverterTypeFfiConsentEntityType_lift(_ buf: RustBuffer) throws -> FfiConsentEntityType {
	try FfiConverterTypeFfiConsentEntityType.lift(buf)
}
...
public func FfiConverterTypeFfiConsentEntityType_lower(_ value: FfiConsentEntityType) -> RustBuffer {
	FfiConverterTypeFfiConsentEntityType.lower(value)
}
...
public func FfiConverterTypeFfiConsentState_lift(_ buf: RustBuffer) throws -> FfiConsentState {
	try FfiConverterTypeFfiConsentState.lift(buf)
}
...
public func FfiConverterTypeFfiConsentState_lower(_ value: FfiConsentState) -> RustBuffer {
	FfiConverterTypeFfiConsentState.lower(value)
}
...
public func FfiConverterTypeFfiContentType_lift(_ buf: RustBuffer) throws -> FfiContentType {
	try FfiConverterTypeFfiContentType.lift(buf)
}
...
public func FfiConverterTypeFfiContentType_lower(_ value: FfiContentType) -> RustBuffer {
	FfiConverterTypeFfiContentType.lower(value)
}
...
public func FfiConverterTypeFfiConversationMessageKind_lift(_ buf: RustBuffer) throws -> FfiConversationMessageKind {
	try FfiConverterTypeFfiConversationMessageKind.lift(buf)
}
...
public func FfiConverterTypeFfiConversationMessageKind_lower(_ value: FfiConversationMessageKind) -> RustBuffer {
	FfiConverterTypeFfiConversationMessageKind.lower(value)
}
...
public func FfiConverterTypeFfiConversationType_lift(_ buf: RustBuffer) throws -> FfiConversationType {
	try FfiConverterTypeFfiConversationType.lift(buf)
}
...
public func FfiConverterTypeFfiConversationType_lower(_ value: FfiConversationType) -> RustBuffer {
	FfiConverterTypeFfiConversationType.lower(value)
}
...
public func FfiConverterTypeFfiCryptoError_lift(_ buf: RustBuffer) throws -> FfiCryptoError {
	try FfiConverterTypeFfiCryptoError.lift(buf)
}
...
public func FfiConverterTypeFfiCryptoError_lower(_ value: FfiCryptoError) -> RustBuffer {
	FfiConverterTypeFfiCryptoError.lower(value)
}
...
public struct FfiConverterTypeFfiDecodedMessageBody: FfiConverterRustBuffer {
	...
	public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiDecodedMessageBody {
		let variant: Int32 = try readInt(&buf)
		switch variant {
		case 1: return try .text(FfiConverterTypeFfiTextContent.read(from: &buf))

		case 2: return try .reaction(FfiConverterTypeFfiReactionPayload.read(from: &buf))

		case 3: return try .attachment(FfiConverterTypeFfiAttachment.read(from: &buf))

		case 4: return try .remoteAttachment(FfiConverterTypeFfiRemoteAttachment.read(from: &buf))

		case 5: return try .multiRemoteAttachment(FfiConverterTypeFfiMultiRemoteAttachment.read(from: &buf))

		case 6: return try .transactionReference(FfiConverterTypeFfiTransactionReference.read(from: &buf))

		case 7: return try .groupUpdated(FfiConverterTypeFfiGroupUpdated.read(from: &buf))

		case 8: return try .readReceipt(FfiConverterTypeFfiReadReceipt.read(from: &buf))

		case 9: return try .walletSendCalls(FfiConverterTypeFfiWalletSendCalls.read(from: &buf))

		case 10: return try .intent(FfiConverterTypeFfiIntent.read(from: &buf))

		case 11: return try .actions(FfiConverterTypeFfiActions.read(from: &buf))

		case 12: return try .custom(FfiConverterTypeFfiEncodedContent.read(from: &buf))
...
public func FfiConverterTypeFfiDecodedMessageBody_lift(_ buf: RustBuffer) throws -> FfiDecodedMessageBody {
	try FfiConverterTypeFfiDecodedMessageBody.lift(buf)
}
...
public func FfiConverterTypeFfiDecodedMessageBody_lower(_ value: FfiDecodedMessageBody) -> RustBuffer {
	FfiConverterTypeFfiDecodedMessageBody.lower(value)
}
...
public struct FfiConverterTypeFfiDecodedMessageContent: FfiConverterRustBuffer {
	...
	public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiDecodedMessageContent {
		...
		case 2: return try .reply(FfiConverterTypeFfiEnrichedReply.read(from: &buf))

		case 3: return try .reaction(FfiConverterTypeFfiReactionPayload.read(from: &buf))

		case 4: return try .attachment(FfiConverterTypeFfiAttachment.read(from: &buf))

		case 5: return try .remoteAttachment(FfiConverterTypeFfiRemoteAttachment.read(from: &buf))

		case 6: return try .multiRemoteAttachment(FfiConverterTypeFfiMultiRemoteAttachment.read(from: &buf))

		case 7: return try .transactionReference(FfiConverterTypeFfiTransactionReference.read(from: &buf))

		case 8: return try .groupUpdated(FfiConverterTypeFfiGroupUpdated.read(from: &buf))

		case 9: return try .readReceipt(FfiConverterTypeFfiReadReceipt.read(from: &buf))

		case 10: return try .walletSendCalls(FfiConverterTypeFfiWalletSendCalls.read(from: &buf))

		case 11: return try .intent(FfiConverterOptionTypeFfiIntent.read(from: &buf))

		case 12: return try .actions(FfiConverterOptionTypeFfiActions.read(from: &buf))

		case 13: return try .custom(FfiConverterTypeFfiEncodedContent.read(from: &buf))
...
public func FfiConverterTypeFfiDecodedMessageContent_lift(_ buf: RustBuffer) throws -> FfiDecodedMessageContent {
	try FfiConverterTypeFfiDecodedMessageContent.lift(buf)
}
...
public func FfiConverterTypeFfiDecodedMessageContent_lower(_ value: FfiDecodedMessageContent) -> RustBuffer {
	FfiConverterTypeFfiDecodedMessageContent.lower(value)
}
...
public func FfiConverterTypeFfiDeliveryStatus_lift(_ buf: RustBuffer) throws -> FfiDeliveryStatus {
	try FfiConverterTypeFfiDeliveryStatus.lift(buf)
}
...
public func FfiConverterTypeFfiDeliveryStatus_lower(_ value: FfiDeliveryStatus) -> RustBuffer {
	FfiConverterTypeFfiDeliveryStatus.lower(value)
}
...
public func FfiConverterTypeFfiDirection_lift(_ buf: RustBuffer) throws -> FfiDirection {
	try FfiConverterTypeFfiDirection.lift(buf)
}
...
public func FfiConverterTypeFfiDirection_lower(_ value: FfiDirection) -> RustBuffer {
	FfiConverterTypeFfiDirection.lower(value)
}
...
public func FfiConverterTypeFfiForkRecoveryPolicy_lift(_ buf: RustBuffer) throws -> FfiForkRecoveryPolicy {
	try FfiConverterTypeFfiForkRecoveryPolicy.lift(buf)
}
...
public func FfiConverterTypeFfiForkRecoveryPolicy_lower(_ value: FfiForkRecoveryPolicy) -> RustBuffer {
	FfiConverterTypeFfiForkRecoveryPolicy.lower(value)
}
...
public func FfiConverterTypeFfiGroupMessageKind_lift(_ buf: RustBuffer) throws -> FfiGroupMessageKind {
	try FfiConverterTypeFfiGroupMessageKind.lift(buf)
}
...
public func FfiConverterTypeFfiGroupMessageKind_lower(_ value: FfiGroupMessageKind) -> RustBuffer {
	FfiConverterTypeFfiGroupMessageKind.lower(value)
}
...
public func FfiConverterTypeFfiGroupPermissionsOptions_lift(_ buf: RustBuffer) throws -> FfiGroupPermissionsOptions {
	try FfiConverterTypeFfiGroupPermissionsOptions.lift(buf)
}
...
public func FfiConverterTypeFfiGroupPermissionsOptions_lower(_ value: FfiGroupPermissionsOptions) -> RustBuffer {
	FfiConverterTypeFfiGroupPermissionsOptions.lower(value)
}
...
public func FfiConverterTypeFfiGroupQueryOrderBy_lift(_ buf: RustBuffer) throws -> FfiGroupQueryOrderBy {
	try FfiConverterTypeFfiGroupQueryOrderBy.lift(buf)
}
...
public func FfiConverterTypeFfiGroupQueryOrderBy_lower(_ value: FfiGroupQueryOrderBy) -> RustBuffer {
	FfiConverterTypeFfiGroupQueryOrderBy.lower(value)
}
...
public func FfiConverterTypeFfiIdentifierKind_lift(_ buf: RustBuffer) throws -> FfiIdentifierKind {
	try FfiConverterTypeFfiIdentifierKind.lift(buf)
}
...
public func FfiConverterTypeFfiIdentifierKind_lower(_ value: FfiIdentifierKind) -> RustBuffer {
	FfiConverterTypeFfiIdentifierKind.lower(value)
}
...
public func FfiConverterTypeFfiLogLevel_lift(_ buf: RustBuffer) throws -> FfiLogLevel {
	try FfiConverterTypeFfiLogLevel.lift(buf)
}
...
public func FfiConverterTypeFfiLogLevel_lower(_ value: FfiLogLevel) -> RustBuffer {
	FfiConverterTypeFfiLogLevel.lower(value)
}
...
public func FfiConverterTypeFfiLogRotation_lift(_ buf: RustBuffer) throws -> FfiLogRotation {
	try FfiConverterTypeFfiLogRotation.lift(buf)
}
...
public func FfiConverterTypeFfiLogRotation_lower(_ value: FfiLogRotation) -> RustBuffer {
	FfiConverterTypeFfiLogRotation.lower(value)
}
...
public func FfiConverterTypeFfiMetadataField_lift(_ buf: RustBuffer) throws -> FfiMetadataField {
	try FfiConverterTypeFfiMetadataField.lift(buf)
}
...
public func FfiConverterTypeFfiMetadataField_lower(_ value: FfiMetadataField) -> RustBuffer {
	FfiConverterTypeFfiMetadataField.lower(value)
}
...
public func FfiConverterTypeFfiPermissionLevel_lift(_ buf: RustBuffer) throws -> FfiPermissionLevel {
	try FfiConverterTypeFfiPermissionLevel.lift(buf)
}
...
public func FfiConverterTypeFfiPermissionLevel_lower(_ value: FfiPermissionLevel) -> RustBuffer {
	FfiConverterTypeFfiPermissionLevel.lower(value)
}
...
public func FfiConverterTypeFfiPermissionPolicy_lift(_ buf: RustBuffer) throws -> FfiPermissionPolicy {
	try FfiConverterTypeFfiPermissionPolicy.lift(buf)
}
...
public func FfiConverterTypeFfiPermissionPolicy_lower(_ value: FfiPermissionPolicy) -> RustBuffer {
	FfiConverterTypeFfiPermissionPolicy.lower(value)
}
...
public func FfiConverterTypeFfiPermissionUpdateType_lift(_ buf: RustBuffer) throws -> FfiPermissionUpdateType {
	try FfiConverterTypeFfiPermissionUpdateType.lift(buf)
}
...
public func FfiConverterTypeFfiPermissionUpdateType_lower(_ value: FfiPermissionUpdateType) -> RustBuffer {
	FfiConverterTypeFfiPermissionUpdateType.lower(value)
}
...
public func FfiConverterTypeFfiPreferenceUpdate_lift(_ buf: RustBuffer) throws -> FfiPreferenceUpdate {
	try FfiConverterTypeFfiPreferenceUpdate.lift(buf)
}
...
public func FfiConverterTypeFfiPreferenceUpdate_lower(_ value: FfiPreferenceUpdate) -> RustBuffer {
	FfiConverterTypeFfiPreferenceUpdate.lower(value)
}
...
public func FfiConverterTypeFfiReactionAction_lift(_ buf: RustBuffer) throws -> FfiReactionAction {
	try FfiConverterTypeFfiReactionAction.lift(buf)
}
...
public func FfiConverterTypeFfiReactionAction_lower(_ value: FfiReactionAction) -> RustBuffer {
	FfiConverterTypeFfiReactionAction.lower(value)
}
...
public func FfiConverterTypeFfiReactionSchema_lift(_ buf: RustBuffer) throws -> FfiReactionSchema {
	try FfiConverterTypeFfiReactionSchema.lift(buf)
}
...
public func FfiConverterTypeFfiReactionSchema_lower(_ value: FfiReactionSchema) -> RustBuffer {
	FfiConverterTypeFfiReactionSchema.lower(value)
}
...
public func FfiConverterTypeFfiSignatureKind_lift(_ buf: RustBuffer) throws -> FfiSignatureKind {
	try FfiConverterTypeFfiSignatureKind.lift(buf)
}
...
public func FfiConverterTypeFfiSignatureKind_lower(_ value: FfiSignatureKind) -> RustBuffer {
	FfiConverterTypeFfiSignatureKind.lower(value)
}
...
public func FfiConverterTypeFfiSortBy_lift(_ buf: RustBuffer) throws -> FfiSortBy {
	try FfiConverterTypeFfiSortBy.lift(buf)
}
...
public func FfiConverterTypeFfiSortBy_lower(_ value: FfiSortBy) -> RustBuffer {
	FfiConverterTypeFfiSortBy.lower(value)
}
...
public func FfiConverterTypeFfiSubscribeError_lift(_ buf: RustBuffer) throws -> FfiSubscribeError {
	try FfiConverterTypeFfiSubscribeError.lift(buf)
}
...
public func FfiConverterTypeFfiSubscribeError_lower(_ value: FfiSubscribeError) -> RustBuffer {
	FfiConverterTypeFfiSubscribeError.lower(value)
}
...
public func FfiConverterTypeFfiSyncMetric_lift(_ buf: RustBuffer) throws -> FfiSyncMetric {
	try FfiConverterTypeFfiSyncMetric.lift(buf)
}
...
public func FfiConverterTypeFfiSyncMetric_lower(_ value: FfiSyncMetric) -> RustBuffer {
	FfiConverterTypeFfiSyncMetric.lower(value)
}
...
public func FfiConverterTypeFfiSyncWorkerMode_lift(_ buf: RustBuffer) throws -> FfiSyncWorkerMode {
	try FfiConverterTypeFfiSyncWorkerMode.lift(buf)
}
...
public func FfiConverterTypeFfiSyncWorkerMode_lower(_ value: FfiSyncWorkerMode) -> RustBuffer {
	FfiConverterTypeFfiSyncWorkerMode.lower(value)
}
...
public struct FfiConverterTypeGenericError: FfiConverterRustBuffer {
	...
	public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> GenericError {
		...
		case 4: return try .GroupError(
				message: FfiConverterString.read(from: &buf)
			)

		case 5: return try .Signature(
				message: FfiConverterString.read(from: &buf)
			)

		case 6: return try .GroupMetadata(
				message: FfiConverterString.read(from: &buf)
			)

		case 7: return try .GroupMutablePermissions(
				message: FfiConverterString.read(from: &buf)
			)
		...
		case 9: return try .SignatureRequestError(
				message: FfiConverterString.read(from: &buf)
			)

		case 10: return try .Erc1271SignatureError(
				message: FfiConverterString.read(from: &buf)
			)

		case 11: return try .Verifier(
				message: FfiConverterString.read(from: &buf)
			)

		case 12: return try .FailedToConvertToU32(
				message: FfiConverterString.read(from: &buf)
			)

		case 13: return try .Association(
				message: FfiConverterString.read(from: &buf)
			)

		case 14: return try .DeviceSync(
				message: FfiConverterString.read(from: &buf)
			)

		case 15: return try .Identity(
				message: FfiConverterString.read(from: &buf)
			)

		case 16: return try .JoinError(
				message: FfiConverterString.read(from: &buf)
			)

		case 17: return try .IoError(
				message: FfiConverterString.read(from: &buf)
			)

		case 18: return try .Subscription(
				message: FfiConverterString.read(from: &buf)
			)

		case 19: return try .ApiClientBuild(
				message: FfiConverterString.read(from: &buf)
			)

		case 20: return try .Grpc(
				message: FfiConverterString.read(from: &buf)
			)

		case 21: return try .AddressValidation(
				message: FfiConverterString.read(from: &buf)
			)

		case 22: return try .LogInit(
				message: FfiConverterString.read(from: &buf)
			)

		case 23: return try .ReloadLog(
				message: FfiConverterString.read(from: &buf)
			)

		case 24: return try .Log(
				message: FfiConverterString.read(from: &buf)
			)

		case 25: return try .Expired(
				message: FfiConverterString.read(from: &buf)
			)

		case 26: return try .BackendBuilder(
				message: FfiConverterString.read(from: &buf)
			)
...
public func FfiConverterTypeGenericError_lift(_ buf: RustBuffer) throws -> GenericError {
	try FfiConverterTypeGenericError.lift(buf)
}
...
public func FfiConverterTypeGenericError_lower(_ value: GenericError) -> RustBuffer {
	FfiConverterTypeGenericError.lower(value)
}
...
public func FfiConverterTypeIdentityValidationError_lift(_ buf: RustBuffer) throws -> IdentityValidationError {
	try FfiConverterTypeIdentityValidationError.lift(buf)
}
...
public func FfiConverterTypeIdentityValidationError_lower(_ value: IdentityValidationError) -> RustBuffer {
	FfiConverterTypeIdentityValidationError.lower(value)
}
...
public func FfiConverterTypeSigningError_lift(_ buf: RustBuffer) throws -> SigningError {
	try FfiConverterTypeSigningError.lift(buf)
}
...
public func FfiConverterTypeSigningError_lower(_ value: SigningError) -> RustBuffer {
	FfiConverterTypeSigningError.lower(value)
}
...
private struct FfiConverterOptionData: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiDecodedMessage: FfiConverterRustBuffer {
	typealias SwiftType = FfiDecodedMessage?
...
private struct FfiConverterOptionTypeFfiSignatureRequest: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiActions: FfiConverterRustBuffer {
...
private struct FfiConverterOptionTypeFfiContentTypeId: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiForkRecoveryOpts: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiIntent: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiLifetime: FfiConverterRustBuffer {
...
private struct FfiConverterOptionTypeFfiPermissionPolicySet: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiTransactionMetadata: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiWalletCallMetadata: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiActionStyle: FfiConverterRustBuffer {
	typealias SwiftType = FfiActionStyle?
...
private struct FfiConverterOptionTypeFfiConversationType: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiDecodedMessageBody: FfiConverterRustBuffer {
	typealias SwiftType = FfiDecodedMessageBody?
...
private struct FfiConverterOptionTypeFfiDeliveryStatus: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiDirection: FfiConverterRustBuffer {
	typealias SwiftType = FfiDirection?
...
private struct FfiConverterOptionTypeFfiGroupPermissionsOptions: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiGroupQueryOrderBy: FfiConverterRustBuffer {
	typealias SwiftType = FfiGroupQueryOrderBy?
...
private struct FfiConverterOptionTypeFfiMetadataField: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiSignatureKind: FfiConverterRustBuffer {
	typealias SwiftType = FfiSignatureKind?
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiSortBy: FfiConverterRustBuffer {
	typealias SwiftType = FfiSortBy?
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterOptionTypeFfiSyncWorkerMode: FfiConverterRustBuffer {
	typealias SwiftType = FfiSyncWorkerMode?
...
private struct FfiConverterSequenceTypeFfiConversation: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiConversation], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiConversation] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterSequenceTypeFfiConversationListItem: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiConversationListItem], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiConversationListItem] {
		let len: Int32 = try readInt(&buf)
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiDecodedMessage: FfiConverterRustBuffer {
	typealias SwiftType = [FfiDecodedMessage]

	static func write(_ value: [FfiDecodedMessage], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiDecodedMessage] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiDecodedMessage]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiDecodedMessage.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiAction: FfiConverterRustBuffer {
	typealias SwiftType = [FfiAction]

	static func write(_ value: [FfiAction], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiAction] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiAction]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiAction.read(from: &buf))
		}
		return seq
	}
}
...
private struct FfiConverterSequenceTypeFfiConsent: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiConsent], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiConsent] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiConsent]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiConversationMember: FfiConverterRustBuffer {
	typealias SwiftType = [FfiConversationMember]

	static func write(_ value: [FfiConversationMember], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiConversationMember] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiConversationMember]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiConversationMember.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiCursor: FfiConverterRustBuffer {
	typealias SwiftType = [FfiCursor]

	static func write(_ value: [FfiCursor], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiCursor] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiCursor]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiCursor.read(from: &buf))
		}
		return seq
	}
}
...
private struct FfiConverterSequenceTypeFfiHmacKey: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiHmacKey], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiHmacKey] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiHmacKey]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiIdentifier: FfiConverterRustBuffer {
	typealias SwiftType = [FfiIdentifier]

	static func write(_ value: [FfiIdentifier], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiIdentifier] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiIdentifier]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiIdentifier.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiInbox: FfiConverterRustBuffer {
	typealias SwiftType = [FfiInbox]

	static func write(_ value: [FfiInbox], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiInbox] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiInbox]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiInbox.read(from: &buf))
		}
		return seq
	}
}
...
private struct FfiConverterSequenceTypeFfiInboxState: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiInboxState], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiInboxState] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterSequenceTypeFfiInstallation: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiInstallation], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiInstallation] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterSequenceTypeFfiMessageWithReactions: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiMessageWithReactions], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiMessageWithReactions] {
		let len: Int32 = try readInt(&buf)
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiMetadataFieldChange: FfiConverterRustBuffer {
	typealias SwiftType = [FfiMetadataFieldChange]

	static func write(_ value: [FfiMetadataFieldChange], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiMetadataFieldChange] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiMetadataFieldChange]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiMetadataFieldChange.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiRemoteAttachmentInfo: FfiConverterRustBuffer {
	typealias SwiftType = [FfiRemoteAttachmentInfo]

	static func write(_ value: [FfiRemoteAttachmentInfo], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiRemoteAttachmentInfo] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiRemoteAttachmentInfo]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiRemoteAttachmentInfo.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiWalletCall: FfiConverterRustBuffer {
	typealias SwiftType = [FfiWalletCall]

	static func write(_ value: [FfiWalletCall], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiWalletCall] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiWalletCall]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiWalletCall.read(from: &buf))
		}
		return seq
	}
}
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterSequenceTypeFfiBackupElementSelection: FfiConverterRustBuffer {
	typealias SwiftType = [FfiBackupElementSelection]

	static func write(_ value: [FfiBackupElementSelection], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiBackupElementSelection] {
		let len: Int32 = try readInt(&buf)
		var seq = [FfiBackupElementSelection]()
		seq.reserveCapacity(Int(len))
		for _ in 0 ..< len {
			try seq.append(FfiConverterTypeFfiBackupElementSelection.read(from: &buf))
		}
		return seq
	}
}
...
private struct FfiConverterSequenceTypeFfiConsentState: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiConsentState], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiConsentState] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterSequenceTypeFfiContentType: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiContentType], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiContentType] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterSequenceTypeFfiPreferenceUpdate: FfiConverterRustBuffer {
	...
	static func write(_ value: [FfiPreferenceUpdate], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for item in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiPreferenceUpdate] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterDictionaryStringUInt64: FfiConverterRustBuffer {
	static func write(_ value: [String: UInt64], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [String: UInt64] {
		let len: Int32 = try readInt(&buf)
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterDictionaryStringInt64: FfiConverterRustBuffer {
	static func write(_ value: [String: Int64], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for (key, value) in value {
			FfiConverterString.write(key, into: &buf)
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [String: Int64] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterDictionaryStringString: FfiConverterRustBuffer {
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterDictionaryDataTypeFfiKeyPackageStatus: FfiConverterRustBuffer {
	static func write(_ value: [Data: FfiKeyPackageStatus], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for (key, value) in value {
			FfiConverterData.write(key, into: &buf)
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [Data: FfiKeyPackageStatus] {
		let len: Int32 = try readInt(&buf)
...
private struct FfiConverterDictionaryDataSequenceTypeFfiHmacKey: FfiConverterRustBuffer {
	static func write(_ value: [Data: [FfiHmacKey]], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for (key, value) in value {
			FfiConverterData.write(key, into: &buf)
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [Data: [FfiHmacKey]] {
		let len: Int32 = try readInt(&buf)
	...
	@_documentation(visibility: private)
#endif
private struct FfiConverterDictionaryTypeFfiIdentifierBool: FfiConverterRustBuffer {
	static func write(_ value: [FfiIdentifier: Bool], into buf: inout [UInt8]) {
		let len = Int32(value.count)
		writeInt(&buf, len)
		for (key, value) in value {
	...
	static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [FfiIdentifier: Bool] {
		let len: Int32 = try readInt(&buf)
 ...
 * d14n backend url.
 */
public func connectToBackend(v3Host: String, gatewayHost: String?, isSecure: Bool,
                             appVersion: String?) async throws -> XmtpApiClient
{
	try await uniffiRustCallAsync(
		rustFutureFunc: {
			uniffi_xmtpv3_fn_func_connect_to_backend(
				FfiConverterString.lower(v3Host),
				FfiConverterOptionString.lower(gatewayHost),
				FfiConverterBool.lower(isSecure),
				FfiConverterOptionString.lower(appVersion)
			)
		},
		pollFunc: ffi_xmtpv3_rust_future_poll_pointer,
		completeFunc: ffi_xmtpv3_rust_future_complete_pointer,
...
public func createClient(
	...
	nonce: UInt64,
	legacySignedPrivateKeyProto: Data?,
	deviceSyncServerUrl: String?,
	...
	try await uniffiRustCallAsync(
		rustFutureFunc: {
			uniffi_xmtpv3_fn_func_create_client(
				FfiConverterTypeXmtpApiClient_lower(api),
				FfiConverterTypeXmtpApiClient_lower(syncApi),
				...
				FfiConverterOptionString.lower(deviceSyncServerUrl),
				FfiConverterOptionTypeFfiSyncWorkerMode.lower(deviceSyncMode),
				FfiConverterOptionBool.lower(allowOffline),
				FfiConverterOptionBool.lower(disableEvents),
...
public func decodeActions(bytes: Data) throws -> FfiActions {
	try FfiConverterTypeFfiActions_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeAttachment(bytes: Data) throws -> FfiAttachment {
	try FfiConverterTypeFfiAttachment_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeIntent(bytes: Data) throws -> FfiIntent {
	try FfiConverterTypeFfiIntent_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeMultiRemoteAttachment(bytes: Data) throws -> FfiMultiRemoteAttachment {
	try FfiConverterTypeFfiMultiRemoteAttachment_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeReaction(bytes: Data) throws -> FfiReactionPayload {
	try FfiConverterTypeFfiReactionPayload_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeReadReceipt(bytes: Data) throws -> FfiReadReceipt {
	try FfiConverterTypeFfiReadReceipt_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeRemoteAttachment(bytes: Data) throws -> FfiRemoteAttachment {
	try FfiConverterTypeFfiRemoteAttachment_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeReply(bytes: Data) throws -> FfiReply {
	try FfiConverterTypeFfiReply_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
public func decodeTransactionReference(bytes: Data) throws -> FfiTransactionReference {
	try FfiConverterTypeFfiTransactionReference_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
 ...
 */
public func enterDebugWriter(
	directory: String,
	logLevel: FfiLogLevel,
	rotation: FfiLogRotation,
	maxFiles: UInt32
) throws { try rustCallWithError(FfiConverterTypeGenericError_lift) {
 ...
 * A maximum of 'max_files' log files are kept.
 */
public func enterDebugWriterWithLevel(
	directory: String,
	rotation: FfiLogRotation,
	maxFiles: UInt32,
	logLevel: FfiLogLevel
...
public func ethereumAddressFromPubkey(pubkey: Data) throws -> String {
	try FfiConverterString.lift(rustCallWithError(FfiConverterTypeFfiCryptoError_lift) {
...
public func ethereumGeneratePublicKey(privateKey32: Data) throws -> Data {
	try FfiConverterData.lift(rustCallWithError(FfiConverterTypeFfiCryptoError_lift) {
...
public func revokeInstallations(
	...
	try FfiConverterTypeFfiSignatureRequest_lift(rustCallWithError(FfiConverterTypeGenericError_lift) {
...
private let initializationResult: InitializationResult = {
	...
	if uniffi_xmtpv3_checksum_method_fficonversation_leave_group() != 6817 {
		return InitializationResult.apiChecksumMismatch
	}
	...
	if uniffi_xmtpv3_checksum_method_fficonversations_sync_all_conversations() != 29050 {
		return InitializationResult.apiChecksumMismatch
	}
	...
	if uniffi_xmtpv3_checksum_method_ffixmtpclient_sync_preferences() != 36404 {
		return InitializationResult.apiChecksumMismatch
	}
