...
class InvitationTests: XCTestCase {
    ...
    func generatesKnownDeterministicTopic() async throws {
        // address = 0xF56d1F3b1290204441Cb3843C2Cac1C2f5AEd690
        let aliceKeyData = "".web3.bytesFromHex!
        let aliceKeys = try PrivateKey(Data(aliceKeyData))
            
        // address = 0x3De402A325323Bb97f00cE3ad5bFAc96A11F9A34
        let bobKeyData = "".web3.bytesFromHex!
        let bobKeys = try PrivateKey(Data(bobKeyData))
        
        let aliceBundle = try await PrivateKeyBundleV1.generate(wallet: aliceKeys)
        let bobBundle = try await PrivateKeyBundleV1.generate(wallet: bobKeys)
        
        let invite = try InvitationV1.createDeterministic(sender: aliceBundle.toV2(), recipient: bobBundle.toV2().getPublicKeyBundle())
