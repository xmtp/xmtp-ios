...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Pat Nakajima"
  # spec.authors            = { "Pat Nakajima" => "patnakajima@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Pat Nakajima"
