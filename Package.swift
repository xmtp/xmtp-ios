...
let package = Package(
	...
	targets: [
		.binaryTarget(
			...
			url: "https://github.com/xmtp/libxmtp/releases/download/swift-bindings-1.9.2-rc1.2a7b5ea/LibXMTPSwiftFFIDynamic.zip",
			checksum: "dd0c4889976dc5472830733d623f490ce5be7de033fb631f8d128a578e185131"
		),
		.target(
			name: "XMTPiOS",
			dependencies: [
