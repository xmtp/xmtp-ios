...
let package = Package(
	...
	targets: [
		.binaryTarget(
			...
			url: "https://github.com/xmtp/libxmtp/releases/download/swift-bindings-1.7.0-rc2.55196a3/LibXMTPSwiftFFIDynamic.zip",
			checksum: "c3ddcda97f24180317b3fa3f83e1f51d110a2abc79013419cac134ddc139946c"
		),
		.target(
			name: "XMTPiOS",
			dependencies: [
